...
export default function LogIn() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        <TouchableOpacity testID="login-back-btn" style={styles.back} onPress={() => router.back()}>
          <Ionicons name="chevron-back" size={24} color={colors.textPrimary} />
        </TouchableOpacity>

        <View style={styles.body}>
          <Text style={styles.title}>Welcome back</Text>
          <Text style={styles.subtitle}>Log in to your Listorix account.</Text>
...
const createStyles = (colors: ColorScheme) => StyleSheet.create({
  ...
  subtitle: { fontSize: 15, color: colors.textSecondary, marginTop: 6, marginBottom: 24 },
